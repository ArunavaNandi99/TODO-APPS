...
const go = async (client) => {
  try {
    client = new MongoClient('mongodb+srv://admin:arunava@cluster0.r498ndk.mongodb.net/TodoApp1?retryWrites=true&w=majority');
...
const passwordProtected = (req, res, next) => {
  ...
  if (req.headers.authorization == "Basic YXJ1bmF2YTphcnVuYXZh") {
    next()
  } else {
